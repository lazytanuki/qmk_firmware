...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_AZERTY] = LAYOUT(
        ...
        MO(_AZERTY_NUMPAD),  KC_LCTL,       KC_LALT,    KC_LGUI,       MO(_AZERTY_MAJ), MO(_AZERTY_MOD1),  KC_SPC,         MO(_AZERTY_ACCENTS), KC_RCTL,    KC_PGUP,       KC_PGDN,      MO(_AZERTY_SYMBOLS)
        ),
    [_AZERTY_MOD1] = LAYOUT(
    ...
    [_AZERTY_NUMPAD] = LAYOUT(
        ...
        KC_TRNS,             KC_TRNS,       KC_TRNS,    KC_TRNS,       KC_TRNS,         KC_TRNS,           KC_TRNS,        LSFT(KC_0),          KC_NO,      KC_NO,         KC_NO,        KC_TRNS
        ),
    [_AZERTY_SYMBOLS] = LAYOUT(
        ...
        KC_TRNS,             KC_NO,         KC_NO,      KC_NO,         MO(_AZERTY_SYMBOLS_MAJ),           KC_NO,            KC_TRNS,        KC_TRNS,             KC_NO,      KC_NO,         KC_NO,        KC_TRNS
        ),
    [_AZERTY_SYMBOLS_MAJ] = LAYOUT(
        KC_TRNS,             RALT(KC_8),    KC_1,       KC_BSLS,       LSFT(KC_EQL),    LSFT(KC_QUOT),     KC_F12,         KC_F7,               KC_F8,      KC_F9,         KC_NO,        LCTL(LALT(KC_DEL)),
        KC_TRNS,             KC_6,          KC_RBRC,    KC_8,          RALT(KC_7),      RALT(KC_9),        KC_F11,         KC_F4,               KC_F5,      KC_F6,         KC_NO,        KC_NO,
        KC_TRNS,             RALT(KC_6),    KC_SLSH,    RALT(KC_0),    KC_EQL,          RALT(KC_3),        KC_F10,         KC_F1,               KC_F2,      KC_F3,         KC_NO,        KC_NO,
        KC_TRNS,             KC_NO,         KC_NO,      KC_NO,         KC_NO,           KC_TRNS,           KC_TRNS,        KC_TRNS,             KC_NO,      KC_NO,         KC_NO,        KC_TRNS
        ),
    [_FN] = LAYOUT(
        ...
        KC_TRNS,             KC_TRNS,       KC_TRNS,    KC_TRNS,       KC_TRNS,         KC_TRNS,           KC_TRNS,        KC_0,                KC_TRNS,    KC_DOT,        KC_TRNS,      KC_TRNS
        )
};
